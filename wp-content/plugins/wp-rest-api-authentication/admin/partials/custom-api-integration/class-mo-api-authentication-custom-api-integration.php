	...
	class Mo_API_Authentication_Admin_CustomAPIIntegration {
		...
		?>
			<div class="mo_table_layout">
			    <h3> Custom/Third Party Plugin API Authentication <a href="admin.php?page=mo_api_authentication_settings&tab=licensing" target="_blank" rel="noopener noreferrer" style="font-size: small">[UPGRADE]</a> : </h3>
			    <p></p> 	
