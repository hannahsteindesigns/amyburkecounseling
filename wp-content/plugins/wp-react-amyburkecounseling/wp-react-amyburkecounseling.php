<?php
/**
 * Plugin Name:     AmyBurkeCounseling
 * Description:     PLUGIN DESCRIPTION HERE
 * Author:          Hannah Stein
 * Author URI:      https://hannahsteindesigns.com
 * Text Domain:     wp-react-amyburkecounseling
 * Domain Path:     /languages
 * Version:         0.1.0
 *
 * @package         Wp_React_AmyBurkeCounseling
 */

// adapted from https://medium.com/swlh/wordpress-create-react-app-integration-30b41657b79e

// Setting hook to load files.
add_action('wp_enqueue_scripts','rp_load_react_app', 11);
...
function rp_load_react_app($hook){
	...
	foreach ($css_files as $index => $css_file){
		wp_enqueue_style('react-plugin-'.$index, $react_app_build . $css_file, 11);
	}
