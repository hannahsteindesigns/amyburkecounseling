...
const infoContent = '<div id="infoContainer" class="text-center">' +
                      '<a href="https://goo.gl/maps/yQ9xQrrwZA22" target="_blank">Get Directions to Amy Burke Counseling</a>' +
                      '</div>';
...
const Map = () => {
  ...
  useEffect(() => {
    ...
    scriptTag.src = 'https://maps.googleapis.com/maps/api/js?key=AIzaSyAY_GvPsWB5ZeGnukWFLVb4xtN4OtQZEiA';
    scriptTag.id = 'maps_script';
  ...
  useEffect(() => {
    const mapOptions = {
      center: {lat: 33.511219, lng: -86.816567},
      zoom: 15,
      styles: [
        {
